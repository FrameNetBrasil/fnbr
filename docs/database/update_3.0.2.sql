...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mfn_db`.`view_constructionelement` (`idConstruction` INT, `constructionEntry` INT, `constructionIdEntity` INT, `idConstructionElement` INT, `entry` INT, `active` INT, `idEntity` INT, `idColor` INT, `optional` INT, `head` INT, `multiple` INT);
