...
class MsgStatusController extends MController {
    ...
    public function formFind() {
        $auth_msgstatus= new mfn\models\Auth_msgstatus($this->data->id);
    ...
    public function lookup() {
        $model = new mfn\models\Auth_msgstatus();
        $filter->idMsgStatus = $this->data->idMsgStatus;
    ...
    public function save() {
            $auth_msgstatus = new mfn\models\Auth_msgstatus($this->data->auth_msgstatus);
            $auth_msgstatus->save();
